package com.YunTu.LineStream.DayUVDriver.DeepVisit;
...
public class DeepVisitBolt extends BaseRichBolt {
    ...
    */  
	...
	public void prepare(Map map, TopologyContext context, OutputCollector collector) {
		...
		/*
		 * _intervalTime = (long)
		 * map.get(OriginalTopology.DEEPBOLT_INTERVAL_TIME); _intervalNum =
		 * (long) map.get(OriginalTopology.DEEPBOLT_INTERVAL_NUM);
		 */
	}
